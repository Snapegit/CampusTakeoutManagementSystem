...
<div :style='{"minHeight":"500px","padding":"20px 20px 40px","margin":"0px auto","borderColor":"#ddd","background":"#fff","borderWidth":"0px","width":"1200px","position":"relative","borderStyle":"solid"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="菜品口味" prop="caipinkouwei">
            <el-input v-model="ruleForm.caipinkouwei" 
                placeholder="菜品口味" clearable :disabled=" false  ||ro.caipinkouwei"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="商家地址" prop="shangjiadizhi">
            <el-input v-model="ruleForm.shangjiadizhi" 
                placeholder="商家地址" clearable :disabled="true  ||ro.shangjiadizhi"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="菜品库存" prop="alllimittimes">
            <el-input v-model.number="ruleForm.alllimittimes" 
                placeholder="菜品库存" clearable :disabled=" false  ||ro.alllimittimes"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="员工工号" prop="yuangonggonghao">
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="联系方式" prop="lianxifangshi">
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/yuangong/yuangonggonghao', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      yuangonggonghaoChange () {
        this.$http.get('follow/yuangong/yuangonggonghao?columnValue=' + this.ruleForm.yuangonggonghao, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
