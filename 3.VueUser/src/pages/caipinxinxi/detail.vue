	...
	<div class="detail-preview" :style='{"padding":"0 20px 20px","margin":"0 auto","borderColor":"#d3d3d3","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","borderWidth":"0 0px","display":"flex","width":"1200px","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 310px)","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"padding":"0 0 10px","margin":"0","borderColor":"#eee","borderRadius":"0px","flexWrap":"wrap","background":"#fff","borderWidth":"0 0 1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品分类</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.caipinfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品口味</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.caipinkouwei}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品特色</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.caipintese}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>商家地址</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.shangjiadizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>员工工号</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.yuangonggonghao}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>联系方式</div>
					<div  :style='{"padding":"0px 10px 0","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","height":"auto"}'>{{detail.lianxifangshi}}</div>
				</div>
				...
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0px","background":"#b4a078","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('caipinxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0px","background":"#b4a078","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('caipinxinxi','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0px","background":"#b4a078","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('caipinxinxi','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
			...
			<!-- 热门信息 -->
			<div class="hot" :style='{"padding":"20px 0px 0","margin":"30px 0","borderRadius":"8px","textAlign":"center","background":"#fff","flex":"1","width":"calc(100% - 500px)","height":"auto","order":"80"}'>
			  <div :style='{"padding":"0px","borderColor":"#C10D0C","color":"#222","textAlign":"left","display":"inline-block","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"auto","fontSize":"28px","borderStyle":"solid","fontWeight":"600","height":"auto"}'>推荐信息</div>
			  <div :style='{"padding":"0","margin":"30px 0 0","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			    <div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","border":"1px solid #eee","padding":"5px","margin":"0 0 6px","textAlign":"center","background":"#fff","width":"23%","height":"auto"}' @click="toDetail(item)">
			      <img :style='{"width":"100%","margin":"0 auto","objectFit":"cover","borderRadius":"4px","display":"block","height":"150px"}' v-if="item.caipintupian && item.caipintupian.substr(0,4)=='http'" :src="item.caipintupian" alt="">
			      <img :style='{"width":"100%","margin":"0 auto","objectFit":"cover","borderRadius":"4px","display":"block","height":"150px"}' v-else :src="baseUrl + (item.caipintupian?item.caipintupian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"0px 10px 0","margin":"0","borderColor":"#ddd","whiteSpace":"nowrap","color":"#666","textAlign":"center","overflow":"hidden","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"dashed"}'>{{item.caipinmingcheng}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      addCart() {
        ...
        this.cart.yuangonggonghao = this.detail.yuangonggonghao;
        ...
        buyNow() {
            ...
            localStorage.setItem('orderGoods', JSON.stringify([{
                ...
                goodname: this.title,
                yuangonggonghao: this.detail.yuangonggonghao,
		...
		chatClick() {
			...
			if(this.detail.yuangonggonghao == user.yuangonggonghao){
				this.$message.error('不能给自己发信息')
				return false
			}
			this.$http.get('yuangong/query', {
				params: {
					yuangonggonghao: this.detail.yuangonggonghao
				}
			}).then(res => {
				if (res.data && res.data.code == 0) {
					...
					this.fname = res.data.data.yuangonggonghao
					if (res.data.data.touxiang) {
						this.fpic = res.data.data.touxiang.split(',')[0]
					} else if (res.data.data.headportrait) {
						this.fpic = res.data.data.headportrait.split(',')[0]
